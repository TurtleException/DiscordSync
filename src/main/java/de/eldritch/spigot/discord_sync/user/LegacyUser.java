...
public final class LegacyUser implements Turtle {
    ...
    public LegacyUser(long turtle, @Nullable OfflinePlayer player, @Nullable Member member, @Nullable String name) {
        this.id     = turtle;
        this.player = player;
        this.member = member;
        this.name   = name;
